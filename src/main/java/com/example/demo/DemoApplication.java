...
public class DemoApplication {
	...
	ApplicationRunner init(ReservationRepository reservationRepository, UserRepository userRepository,
		...
		return args -> {
			...
			Seat[] seats = { new Seat("T01", true), new Seat("T01", true), new Seat("T03", true) };
			...
			Ticket[] tickets = { new Ticket(19.0, "0101"), new Ticket(25.0, "0202"), new Ticket(35.0,"0102"), new Ticket(15.0,"0203")};
...
//			shows[2].addTicket(tickets[2]);
			...
			screens[0].addShows(shows[1]);
			screens[0].addShows(shows[2]);
